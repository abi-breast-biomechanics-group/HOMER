...
point_middle = MeshNode(loc=[1, 0.5, 0.5])
...
# s.add_mesh(l, render_lines_as_tubes=True, line_width=10)
# s.add_mesh(np.array(l0), render_points_as_spheres=True, point_size=10)
s.show()
