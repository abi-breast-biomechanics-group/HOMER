...
from HOMER import MeshNode, MeshElement, Mesh, L2Basis, H3Basis, L3Basis
...
fitting_mesh = Mesh(nodes = [point0, point1, point2, point3], elements = element0).rebase([L3Basis, L3Basis])
