...
from HOMER.mesh.parameters import column_equilibrated_lstsq, sparse_equilibrated_lstsq
...
__all__ = ['MeshNode', 'MeshElement', 'MeshField', 'Mesh',
           ...
           'quadrature_order', 'GAUSS', 'column_equilibrated_lstsq', 'sparse_equilibrated_lstsq',
